                        ...
                        <div class="widget wgreen">
                            ...
                            <div class="widget-content">
                                <div class="padd">
                                    ...
                                    <h6 align="right">当前进度: ${step}/${size}</h6>
                                    <hr />
                                    <!-- Form starts.  -->

                                    <form class="form-horizontal" action="${pageContext.request.contextPath}/homeworks/practice.do?&step=${step}&size=${size}" method="post">
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-offset-1 col-lg-9">
                                                <button type="button" class="btn btn-info" title="${question.answer}">查看答案</button>
