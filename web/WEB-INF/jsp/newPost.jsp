                    ...
                    <div class="col-md-8">
                        ...
                        <div class="widget wgreen">
                            ...
                            <div class="widget-content">
                                <div class="padd">
                                    <!-- Form starts.  -->
                                    <form class="form-horizontal" action="${pageContext.request.contextPath}/post/getPosts.do?ismodified=1" method="post" >
                                        <div class="form-group">
                                            <label class="control-label col-lg-3" >标题 </label>
                                            <div class="col-lg-10">
                                            <input type="text" class="form-control" placeholder="输入标题" name="titleText">
                                            <br />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                            <div class="text-area">
                                                <textarea class="form-control" name="contentText" placeholder="输入正文"></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        <hr />
